						...
						<div class="container" style="background-color: Gainsboro; padding: 20px; border-radius: 10px;">
						    <table class="styled-table">
						       ...
						       <%
						            ...
						            String sql = "SELECT id_user, firstname, surname, email, address, zip_code, city, country, phone_number, role, status_user FROM user WHERE role = 'user' ORDER BY id_user";
