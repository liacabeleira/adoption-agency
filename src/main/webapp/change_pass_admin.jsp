			...
			<div id="wrapper">
		        ...
		        <header id="header">
			        ...
			        <div class="container" style="background-color: Gainsboro; padding: 20px; border-radius: 10px;">
			            <form action="update_pass_admin.jsp" method="POST">
			                <table class="styled-table">
			                  ...
			                  <!-- Botões -->
					           <div style="margin-top: 20px; text-align: center;">
								    <button onclick="window.location.href='update_pass_admin.jsp'" 
								    ...
								    <button onclick="window.location.href='account_admin.jsp'" 
