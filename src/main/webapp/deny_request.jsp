		            ...
		            <h1>Deny Request</h1>  
		        		...
		        		<%
			                ...
			                try {
			                    ...
			                    // Actualizar status do pedido para "Rejected"
			                    String updateRequestSql = "UPDATE adoption_request SET status_request = 'Rejected' WHERE id_request = ?";
			                    ...
			                    psInsertLog.setString(2, "Denied adoption request ID: " + idRequest);
			                    psInsertLog.executeUpdate();
		
			                    out.println("<p style='color: green;'>Sucessfully rejected request! </p>");
		
			                } catch (Exception e) {
			                	out.println("<p style='color: red;'>Error rejecting request </p>");
			                } finally {
			                    // Fechar conexões
