			...
			<div id="wrapper">
		        ...
		        <header id="header">
		            <h1>Add New Species</h1>  
		      		...
		      		<!-- Formulário para adicionar uma nova espécie -->
					<form action="ver_new_species.jsp" method="POST">
					    <table class="styled-table">
					        <tr>
					            <td style="padding: 10px; border: 1px solid #ddd;">Species Name:</td>
					            <td style="padding: 10px; border: 1px solid #ddd;">
					                <input type="text" name="new_species_name" placeholder="Enter species name" required 
