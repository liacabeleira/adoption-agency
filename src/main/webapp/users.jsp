		        ...
		        <header id="header">
		            <h1>All Users</h1>  
						...
						<div style="margin-bottom: 20px; text-align: center;">
						    <form action="user_search.jsp" method="get" style="display: inline-block;">
						        <input type="text" name="email" placeholder="Search by Email" 
						               style="padding: 10px; width: 300px; border: 1px solid #ccc; border-radius: 4px; color: black;">
						        <button type="submit" 
						...
						<div class="container" style="background-color: Gainsboro; padding: 20px; border-radius: 10px;">
						    <table class="styled-table">
						       ...
						       <%
						            ...
						            String sql = "SELECT id_user, firstname, surname, email, address, zip_code, city, country, phone_number, role, status_user FROM user ORDER BY id_user";
					    ...
					    <div style="margin-top: 20px; text-align: center;">
					        <button onclick="window.location.href='admin_list.jsp'" 
					        ...
					        <button onclick="window.location.href='users_list.jsp'" 
					                style="padding: 10px 20px; margin-right: 10px; background-color: #4CAF50; color: white; border: none; cursor: pointer; border-radius: 4px;">
					            Users List
					        </button>
