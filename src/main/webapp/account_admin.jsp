	...
	<body class="is-preload">
		...
		<!-- Wrapper -->
           ...
           <div style="margin-top: 20px; text-align: center;">
			    <button onclick="window.location.href='edit_details_admin.jsp'" 
			    ...
			    <button onclick="window.location.href='change_pass_admin.jsp'" 
			            style="padding: 10px 20px; background-color: #008CBA; color: white; border: none; cursor: pointer; border-radius: 4px;">
			        Change Password
			    </button>
			    <button onclick="window.location.href='index_admin.jsp'" style="padding: 10px 20px; background-color: #f44336; color: white; border: none; cursor: pointer; border-radius: 4px;">
					  Back
					</button>
			</div>
		</div>
