		...
		<!-- Wrapper -->
			...
			<div class="container" style="background-color: Gainsboro; padding: 20px; border-radius: 10px;">
			    <table class="styled-table">
			        ...
			        <%
			            // Query para obter as espécies
			            String sql = "SELECT id_species, name_species FROM species ORDER BY id_species";
			            ...
			            while (rs.next()) {
			                ...
			                String nameSpecies = rs.getString("name_species");
			
			                out.println("<tr>");
			                out.println("<td>" + idSpecies + "</td>");
			                out.println("<td>" + nameSpecies + "</td>");
			
			                // Botão Edit
			                out.println("<td>");
			                out.println("<form action='edit_species.jsp' method='post'>");
			                out.println("<input type='hidden' name='id_species' value='" + idSpecies + "' />");
			                ...
			                // Botão Delete
			                out.println("<td>");
			                out.println("<form action='delete_species.jsp' method='post'>");
			                out.println("<input type='hidden' name='id_species' value='" + idSpecies + "' />");
		           ...
		           <div style="margin-top: 20px; text-align: center;">
					    <button onclick="window.location.href='add_species.jsp'" 
