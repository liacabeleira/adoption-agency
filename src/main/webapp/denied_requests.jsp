					    ...
					    <table class="styled-table">
					        ...
					        <% 
						         String sql = "SELECT adoption_request.id_request, adoption_request.request_date, " +
							                     ...
							                     " JOIN user ON adoption_request.id_user = user.id_user WHERE status_request = 'Rejected'";
					        ...
					        <div style="margin-top: 20px;">
					            <button type="button" onclick="window.location.href='requests.jsp'" style="padding: 10px 20px; background-color: #f44336; color: white; border: none; cursor: pointer; border-radius: 4px;">
					                Back
					            </button>
					        </div>
					      </div>
